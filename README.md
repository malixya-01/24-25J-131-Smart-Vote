...
📌 Ensures **secure and accurate registration** of voters using **biometric data** (fingerprints & facial recognition). The collected data is **securely stored on the blockchain**, preventing tampering and ensuring voter authenticity.
...
- **🧠 Machine Learning:** LSTM for **fraud detection** & ANN for **predictive analytics**
- **🎨 Frontend:** ////////
- **🖥️ Backend:** ////////
- **🗄️ Database:** ////////
